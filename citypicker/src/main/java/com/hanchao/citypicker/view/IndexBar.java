...
import com.hanchao.citypicker.helper.IIndexBarDataHelper;
import com.hanchao.citypicker.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndexDatas.size(); i++) {
            index = mIndexDatas.get(i);
            Paint.FontMetrics fontMetrics = mPaint.getFontMetrics();//获得画笔的FontMetrics，
